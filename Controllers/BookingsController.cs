...
namespace HotelManagementSystem.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public BookingsController(HotelManagementSystemDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingId,RoomNo,UserId,BookingStatus,PaymentStatus,DurationStart,DurationEnd,BookingTime")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,RoomNo,UserId,BookingStatus,PaymentStatus,DurationStart,DurationEnd,BookingTime")] Booking booking)
        {
